 ...
 * @author Aluno
 */
public class TelaManutencaoProdutos extends javax.swing.JDialog {

    ControleProdutos controle = new ControleProdutos();

    public TelaManutencaoProdutos(Frame owner, boolean modal) {
        super(owner, modal);
        initComponents();
    ...
    private void botNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoActionPerformed
        ...
        TelaDadosProduto tela = new TelaDadosProduto(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaManutencaoProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaManutencaoProdutos(null, true).setVisible(true);
            }
        });
    }
