 ...
 * @author Aluno
 */
public class TelaManutencaoProdutosCombo extends javax.swing.JDialog {

    ControleProdutos controle = new ControleProdutos();

    public TelaManutencaoProdutosCombo(Frame owner, boolean modal) {
        super(owner, modal);
        initComponents();
        
        tabProduto.getColumnModel().getColumn(0).setPreferredWidth(30);
        tabProduto.getColumnModel().getColumn(1).setPreferredWidth(250);
        tabProduto.getColumnModel().getColumn(0).setPreferredWidth(100);
    ...
    private void atualizarTabela()
    {
        ...
        for(Produto p : controle.getTodos())
        {
    ...
    private void initComponents() {
        ...
        jPanel2.setMaximumSize(new java.awt.Dimension(468, 35));
    ...
    private void botNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoActionPerformed
        ...
        TelaDadosProdutoCombo tela = new TelaDadosProdutoCombo(null, true);
    ...
    private void botAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAlterarActionPerformed
        ...
        else
        {
            ...
            tela.setProduto(controle.getProduto(linha));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaManutencaoProdutosCombo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaManutencaoProdutosCombo(null, true).setVisible(true);
            }
        });
    }
