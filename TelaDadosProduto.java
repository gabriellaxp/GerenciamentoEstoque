 ...
 * @author Aluno
 */
public class TelaDadosProduto extends javax.swing.JDialog {

    private boolean confirmou=false;

    private Categoria categoriaSelecionada;
    
    public TelaDadosProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void botPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botPesquisarActionPerformed
        TelaPesquisaCategoria tela = new TelaPesquisaCategoria(null, true);
        tela.setVisible(true);
        if (tela.isSelecionou())
        {
            this.categoriaSelecionada = tela.getCategoriaSelecionada();
            txtCategoria.setText(this.categoriaSelecionada.getNome());
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaDadosProduto dialog = new TelaDadosProduto(new javax.swing.JFrame(), true);
